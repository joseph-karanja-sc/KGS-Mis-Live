...
Route::group(['prefix' => 'identificationEnrollment'], function () {
    Route::group(['middleware' => ['web']], function () {
        ...
        Route::get('getEnrolmentDashboardData', 'IdentificationEnrollmentController@getEnrolmentDashboardData');
        Route::post('exportEnrolmentRecords', 'IdentificationEnrollmentController@exportEnrolmentRecords');
    });
});
