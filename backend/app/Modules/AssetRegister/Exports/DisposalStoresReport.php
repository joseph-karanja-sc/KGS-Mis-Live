...
class DisposalStoresReport  implements FromCollection,WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    ...
    { 
       ...
       ->join('stores_asset_depreciation as t4','t4.asset_id','t1.id')
       ->join('stores_depreciation_methods as t6','t6.id','depreciation_method_id')
